            ...
            <ul>
              <li className={styles.dropdown}>
                ...
                <div className={styles.dropdownContent}>
                  ...
                  <div style={{ display: "grid", width: "80%", gridTemplateColumns: "repeat(10, auto) " }}>

                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" ,fontStyle:"1px" }}>
                      ...
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Indian & Festive Wear</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      <div style={{ color: "red" }}>Bottomwear</div>
                      <div> T-Shirts  </div>
                      <div>Casual Trousers</div>
                      <div>Shorts</div>
                      <div>Track Pants & Joggers</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Innerwear & Sleepwear</div>
                      <div>Briefs & Trunks</div>
                      <div>Boxers</div>
                      <div>Vests</div>
                      <div>Sleepwear & Loungewear</div>
                      <div>Thermals</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Plus Size</div>
                      <div>Kurtas & Kurta Sets</div>
                      <div>Sherwanis</div>
                      <div>Nehru Jackets</div>
                      <div>Dhotis</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Flip Flops</div>
                      <div>Socks</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Personal Care & Grooming</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Swimwaer</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Gadgets</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Helmets</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Bags & Backpacks</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Luggages & Trolley</div>
              ...
              <li className={styles.dropdown}>
                <a href="" className={styles.dropbtn} style={linkStyle} >WOMEN</a>
                <div className={styles.dropdownContent}>
                  ...
                  <div style={{ display: "grid", width: "80%", gridTemplateColumns: "repeat(10, auto) " }}>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Jackets</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Belts, Scarves & More</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Watches & Wearables</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div style={{ color: "red" , borderTop: "1px solid red"  }}>Footwear</div>
                      <div>Flats</div>
                      <div>Casual Shoes</div>
                      <div>Heels</div>
                      <div>Boots</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Sports & Active Wear</div>
                      <div>Clothing</div>
                      <div>Footwear</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Beauty & Personal Care</div>
                      <div>Makeup</div>
                      <div>Skincare</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Headphones</div>
                      <div>Speakers</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Jewellery</div>
                      <div>Fashion Jewellery</div>
                      <div>Fine Jewellery</div>
                      <div>Earrings</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Backpacks</div>
              ...
              <li className={styles.dropdown}>
                <a href="" className={styles.dropbtn} style={linkStyle} >KIDS</a>
                <div className={styles.dropdownContent}>

                  <div style={{ display: "grid", width: "60%", gridTemplateColumns: "repeat(5, auto) " }}>

                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", marign: "10px", padding: "10px" }}>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", marign: "10px", padding: "10px" }}>
                      ...
                      <div>Flip Flops</div>
                      <div>Socks</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Toys</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", marign: "10px", padding: "10px" }}>
                      ...
                      <div>Infant Care</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Home & Bath</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", marign: "10px", padding: "10px" }}>
                      ...
                      <div>Caps & Hats</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Brands</div>
                      <div>H&M</div>
                      <div>Max Kids</div>
                      <div>Pantaloons</div>
              ...
              <li className={styles.dropdown}>
                <a href="" className={styles.dropbtn} style={linkStyle} >HOME & LIVING</a>
                <div className={styles.dropdownContent}>
                  ...
                  <div style={{ display: "grid", width: "80%", gridTemplateColumns: "repeat(10, auto) " }}>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Sofa Covers</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Flooring</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Lamps & Lighting</div>
                      <div>Floor Lamps</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div style={{ color: "red"  ,borderTop:"1px solid red"}}>Curtains</div>
                      <div style={{ color: "red" }}>Cushions & Cushion Covers</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Storage</div>
                      <div>Bins</div>
                      <div>Hangers</div>
                      <div>Organisers</div>
              ...
              <li className={styles.dropdown}>
                <a href="" className={styles.dropbtn} style={linkStyle} >BEAUTY</a>
                <div className={styles.dropdownContent}>
                  ...
                  <div style={{ display: "grid", width: "80%", gridTemplateColumns: "repeat(10, auto) " }}>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Body Scrub</div>
                      <div>Hand Cream</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Baby Care</div>
                      <div>Masks</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Fragrances</div>
                      <div>Perfume</div>
                      <div>Deodorant</div>
                      <div>Body Mist</div>
                    ...
                    <div style={{ display: "grid", width: "80%", gridTemplateRows: "repeat(20,auto) ", textAlign: "left", margin: "10px", padding: "10px" }}>
                      ...
                      <div>Hair Dryer</div>
                      <div>Epilator</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Men's Grooming</div>
                      <div>Trimmers</div>
                      <div>Beard Oil</div>
                      <div>Hair Wax</div>
                      <div style={{ color: "red", borderTop: "1px solid red" }}>Beauty Gift & Makeup Set</div>
                      <div>Beauty Gift</div>
                      <div>Makeup Kit</div>
                      <div>Premium Beauty</div>
              ...
              <li className={styles.dropdown}>
                <a href="" className={styles.dropbtn} style={linkStyle} >STUDIO</a>
                <div className={styles.dropdownContent}>

                  <div style={{ width: "600px" }}>
                    <img src="https://constant.myntassets.com/web/assets/img/studio-logo-new.svg" alt="" style={{ width: "100px", marginTop: "10px" }} />
                    <div>
                      Your daily inspiration for everything fashion
                    </div>
                    <img src="https://constant.myntassets.com/web/assets/img/sudio-nav-banner.png" alt="" style={{ width: "600px", marginTop: "10px" }} />
                    <button style={{ backgroundColor: "lightblue", margin: "10px" }}>
          EXPLORE STUDION >
                    </button>
                  </div>
